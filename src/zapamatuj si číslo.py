...
while True:
    ...
    if timer==0:
        ...
        okno.blit(text3, (315,300))
        okno.blit(text4, (315,400))
    if timer==1:
        text4=font.render("1AU =    150*10^9    m", True, (0, 0, 0))
        if vybrane==1:
            okno.blit(text1, (315,500))
        if vybrane==2:
            okno.blit(text2, (315,500))
        if vybrane==3:
            okno.blit(text3, (280,500))
        if vybrane==4:
            okno.blit(text4, (200,500))
        pygame.draw.rect(okno,(0,0,0),(462,498,236,104))
        pygame.draw.rect(okno,(255,255,255),(465,500,230,100))
        if vybrane==2 or vybrane==4:
            pygame.draw.rect(okno,(0,0,0),(877,498,136,104))
            pygame.draw.rect(okno,(255,255,255),(880,500,130,100))
    text=font.render(napsano,True, (0,0,0))    
    okno.blit(text,(465,500))
    text=font.render(napsano2,True, (0,0,0))
    okno.blit(text,(880,500))
